...
HPData={"HPfactor":1.5}
configData={"daysForecast":1,"startBuilding":19,"endBuilding":34,"startDay":1,"endDay":365,"buildingTypes":buildingTypes,"nUsers":nUsers}
...
run_district_func.run(target_path,stoData,HPData,configData,inputData,parallelData)