...
model OFD_IdealHeaters
  ...
  AixLib.Building.HighOrder.House.OFD_MiddleInnerLoadWall.BuildingEnvelope.GroundFloorBuildingEnvelope
    GF(
    TMC=TMC,
    TIR=TIR,
  ...
  AixLib.Building.HighOrder.Rooms.OFD.Attic_Ro2Lf5 Attic(
    length=10.64,
    room1_length=5.875,
    room2_length=3.215,
    room3_length=3.92,
  ...
  AixLib.Utilities.Interfaces.SolarRad_in SolarRadiationPort[7]
    "[1:7]=[N, E, S, W, RoofN, RoofS,Horizontal]"
...
equation
  ...
  connect(UF.ThermChildren1,UF_Hydraulic.Con_Children1)  annotation(Line(points={{1.6,
  ...
  connect(Attic.SolarRadiationPort_RO1, SolarRadiationPort[6]) annotation(Line(points={{-14.5,
          84},{-16,84},{-16,90},{74,90},{74,-22},{172,-22},{172,95.7143},{190,
          95.7143}},                                                                                                    color = {255, 128, 0}));
  connect(Attic.SolarRadiationPort_RO2, SolarRadiationPort[5]) annotation(Line(points={{8.5,84},
          {8,84},{8,90},{74,90},{74,-22},{172,-22},{172,92.8571},{190,92.8571}},                                                                                              color = {255, 128, 0}));
  connect(Attic.SolarRadiationPort_OW1, SolarRadiationPort[4]) annotation(Line(points={{-27.38,
          62},{-44,62},{-44,90},{74,90},{74,-22},{172,-22},{172,90},{190,90}},                                          color = {255, 128, 0}));
  connect(Attic.SolarRadiationPort_OW2, SolarRadiationPort[2]) annotation(Line(points={{22.3,
          62.4},{36,62.4},{36,90},{74,90},{74,-20},{172,-20},{172,84.2857},{190,
          84.2857}},                                                                                                                                                                 color = {255, 128, 0}));
