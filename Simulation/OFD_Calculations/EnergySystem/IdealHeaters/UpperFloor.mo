...
model UpperFloor
  ...
  AixLib.Utilities.Interfaces.Star Rad_Bedroom
    annotation (Placement(transformation(extent={{-149,80},{-129,100}})));
  Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_a Con_Bedroom annotation(Placement(transformation(extent = {{-150, 49}, {-130, 69}})));
  AixLib.Utilities.Interfaces.Star Rad_Children2
    annotation (Placement(transformation(extent={{-149,-25},{-129,-5}})));
  ...
  AixLib.Utilities.Interfaces.Star Rad_Children1
    annotation (Placement(transformation(extent={{127,63},{147,83}})));
  Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_a Con_Children1 annotation(Placement(transformation(extent = {{129, 40}, {149, 60}})));
  AixLib.Utilities.Interfaces.Star Rad_Bath
  ...
  Modelica.Blocks.Math.Gain         PI_bedroom(k=1000)                                                                                              annotation(Placement(transformation(extent = {{-99, -1}, {-79, 19}})));
  ...
  Modelica.Blocks.Math.Gain         PI_children1(k=1000)                                                                                              annotation(Placement(transformation(extent = {{24, 46}, {44, 66}})));
  ...
  Modelica.Blocks.Math.Gain         PI_bath(k=1000)                                                                                              annotation(Placement(transformation(extent = {{37, -54}, {57, -34}})));
  ...
  Modelica.Blocks.Math.Gain         PI_children2(k=1000)                                                                                              annotation(Placement(transformation(extent = {{-103, -59}, {-83, -39}})));
...
equation
  ...
  connect(SourceConv_children1.port,Con_Children1)  annotation(Line(points = {{90, 65}, {139, 65}, {139, 50}}, color = {191, 0, 0}));
  ...
  connect(PI_bedroom.u, TSet_UF[1]) annotation (Line(points={{-101,9},{-129,9},
          {-129,85.75},{-71,85.75}}, color={0,0,127}));
  connect(PI_children2.u, TSet_UF[4]) annotation (Line(points={{-105,-49},{-130,
          -49},{-130,108.25},{-71,108.25}}, color={0,0,127}));
  connect(PI_children1.u, TSet_UF[2]) annotation (Line(points={{22,56},{0,56},{
          0,93.25},{-71,93.25}}, color={0,0,127}));
  connect(PI_bath.u, TSet_UF[3]) annotation (Line(points={{35,-44},{18,-44},{18,
          -45},{0,-45},{0,100.75},{-71,100.75}}, color={0,0,127}));
